...
namespace ModelLearner.Algorithms.LOUGA.FitnessFunctions
{
    ...
    /// </summary>
    class IntegerErrorRateFunction : IFitnessFunction<IntegerIndividual>
    {
        /// <summary>
        /// Model description.
        /// </summary>
        ...
        public IntegerErrorRateFunction(Model m, IntegerIndividualRepresenter representer, List<World> worlds)
        {
            this.M = m;
